 ...
 *
 * Definitions are ordered deliberately. When a village has a real nearby landmark that makes a
 * better story, the structure-grounded variant is offered before the generic local fallback. This
 * makes two villages in the same cell play differently without inventing destinations that do not
 * exist. Bountiful remains the repeatable civic layer.
 */
final class VillageQuestCatalog {
    static final Definition EMPTY_STALLS = new Definition(
            "hearthlands_community_empty_stalls",
            "The Empty Stalls",
            ...
            0,
            "the old stables",
            List.of(new ResourceLocation("dungeons_enhanced", "stables")),
            0,
            id("community_empty_stalls_offer"),
            id("community_empty_stalls_active"),
            id("community_empty_stalls_turnin"),
            false,
            List.of(),
            List.of(new RewardStack(new ResourceLocation("minecraft", "saddle"), 1, "Recovered Riding Tack")),
            4,
            5
    );
    ...
    static final Definition SAFE_PASTURE = new Definition(
            ...
            false,
            List.of(),
            List.of(new RewardStack(new ResourceLocation("minecraft", "leather"), 4, null)),
            4,
            4
    );

    static final Definition OLD_WALLS_OLD_NAMES = new Definition(
            "hearthlands_exploration_old_walls",
            "Old Walls, Old Names",
            ...
            0,
            id("exploration_old_walls_offer"),
            id("exploration_old_walls_active"),
            id("exploration_old_walls_turnin"),
            false,
            List.of(),
            List.of(new RewardStack(new ResourceLocation("minecraft", "iron_pickaxe"), 1, "Surveyor's Pick")),
            4,
            5
    );
    ...
    static final Definition QUIET_WATCH = new Definition(
            "hearthlands_profession_quiet_watch",
            ...
            0,
            id("profession_quiet_watch_offer"),
            id("profession_quiet_watch_active"),
            id("profession_quiet_watch_turnin"),
            false,
            List.of(),
            List.of(new RewardStack(new ResourceLocation("minecraft", "crossbow"), 1, "Watch Crossbow")),
            5,
            5
    );
    ...
    // Structure-grounded alternatives are intentionally ordered before generic fallbacks. The
    // quest manager withholds them when no legal generated target exists, then naturally falls
    // through to the local version.
